    ...
    >
      ...
      >
        <div class="mb-5" id="headers">
          <VueWriter
            class="font-geom text-ci-purple font-semibold lg:text-2xl xl:text-4xl m-0"
            :array="string"
            :eraseSpeed="50"
            :typeSpeed="100"
          >
          ...
          <h1
            class="font-geom text-white lg:text-3xl xl:text-5xl m-0 font-light break-all"
          >
            DEVELOPER AND GRAPHIC DESIGNER
          </h1>
          <div
            class="mt-2 md:mt-5 flex justify-center md:justify-normal space-x-5"
          >
            <a
              v-for="item in socials"
              :key="item.name"
              :href="item.href"
              class="text-white hover:text-ci-purple"
            >
...
const string = [
  "HEY MY NAME IS", // English
  "HEY MEIN NAME IST", // German
  "HOLA, MI NOMBRE ES", // Spanish
  "MERHABA, BENİM ADIM", // Turkish
  "HELLO, MENO JME JE", // Czech
  "SALUT, MON NOM EST", // French
  "ΓΕΙΑ ΜΟΥ ΤΟ ΟΝΟΜΑ ΕΙΝΑΙ", // Greek
  "HALLO, MIJN NAAM IS", // Dutch
  "CIAO, IL MIO NOME È", // Italian
  "こんにちは、私の名前は", // Japanese
  "여보세요, 내 이름은", // Korean
  "HEJ, MITT NAMN ÄR", // Swedish
  "САЛАМ, ИМЯ МЕНЯ", // Russian
];

const socials = [
  {
    name: "E-Mail",
    href: "mailto:contact@liamrbsn.com",
  ...
  {
    name: "GitHub",
    href: "https://github.com/MnkyArts/",
    icon: defineComponent({
      render: () =>
  ...
  {
    name: "Instagram",
    href: "https://www.instagram.com/liam.rbsn/",
    icon: defineComponent({
      render: () =>
        h("svg", { fill: "currentColor", viewBox: "0 0 24 24" }, [
          h("path", {
  ...
  {
    name: "Twitter",
    href: "https://twitter.com/MnkyArts_",
    icon: defineComponent({
      render: () =>
        h("svg", { fill: "currentColor", viewBox: "0 0 24 24" }, [
          h("path", {
